...
public class UniversityWrapperTest {
	...
	public static UniversityWrapper.Professor bienve = new UniversityWrapper.Professor(101, "Bienve", "V�lez", "CSE");
	public static UniversityWrapper.Professor juan = new UniversityWrapper.Professor(101, "Jos�", "Rivera", "Math");

	public static UniversityWrapper.StaffMember receptionistCSE = new UniversityWrapper.StaffMember(101, "Jenniffer Ortiz", "CSE");
	public static UniversityWrapper.StaffMember receptionistMath = new UniversityWrapper.StaffMember(101, "Jos� Rivera", "Math");
	...
	public static UniversityWrapper.Student maria = new UniversityWrapper.Student(1, "Maria", "Mart�nez", false);
	...
	public void testDrop() {
		UniversityWrapper.Student pepe = new UniversityWrapper.Student(9, "Pepe", "Ram�rez", false);
	...
	public void testTakeSameCourse() {
		...
		assertTrue("takeSameCourse: returns true incorrectly", UPRM.takeSameCourse(pedro, carmen));
		assertTrue("takeSameCourse: returns true incorrectly", UPRM.takeSameCourse(carla, maria));
	}
	@Test
